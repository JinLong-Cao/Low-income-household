...
```{r}
with_subsidies$Scenario.1..Family.of.Four..Ontario.Works = char_to_int(with_subsidies$Scenario.1..Family.of.Four..Ontario.Works)

with_subsidies$Scenario.2..Family.of.Four..Full.Time.Minimum.Wage.Earner = char_to_int(with_subsidies$Scenario.2..Family.of.Four..Full.Time.Minimum.Wage.Earner)

with_subsidies$Scenario.3..Family.of.Four..Median.Income = char_to_int(with_subsidies$Scenario.3..Family.of.Four..Median.Income)

with_subsidies$Scenario.4..Single.Parent.Household.with.2.Children..Ontario.Works = char_to_int(with_subsidies$Scenario.4..Single.Parent.Household.with.2.Children..Ontario.Works)

with_subsidies$Scenario.5..One.person.Household..Ontario.Works = char_to_int(with_subsidies$Scenario.5..One.person.Household..Ontario.Works)

with_subsidies$Scenario.6..One.Person.Household..Ontario.Disability.Support.Program = char_to_int(with_subsidies$Scenario.6..One.Person.Household..Ontario.Disability.Support.Program)

with_subsidies$Scenario.7..One.Person.Household..Old.Age.Security..Guaranteed.Annual.Income.Supplement = char_to_int(with_subsidies$Scenario.7..One.Person.Household..Old.Age.Security..Guaranteed.Annual.Income.Supplement)

with_subsidies$Scenario.8..Married.Couple..Ontario.Disability.Support.Program = char_to_int(with_subsidies$Scenario.8..Married.Couple..Ontario.Disability.Support.Program)

with_subsidies$Scenario.9..Single.Person.Household..Full.Time.Minimum.Wage.Earner = char_to_int(with_subsidies$Scenario.9..Single.Person.Household..Full.Time.Minimum.Wage.Earner)
